...
from healthcheckcore.config import read_config
from healthcheckcore.plugin import Result, Results, json_to_results
from healthcheckcore.output import output_registry
from healthcheckcore.service import ServiceCheck
...
def parse_options(output_registry):
    ...
    parser.add_argument('--source', dest='source',
                        default=None,
                        help='Source of checks, e.g. healthcheck.foo.bar')
